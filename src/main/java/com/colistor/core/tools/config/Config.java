...
public class Config {
    ...
    public Config() {
        ...
        // Use relative paths
        Environment environment = new ImmutableEnvironment("/home/joel/config.yaml");
    ...
    public ColistorConfig get() {
        return configurationProvider.bind("colistor", ColistorConfig.class);
    }
}
